...
export const Route = createFileRoute("/policies/restricted")({
  head: () => ({
    meta: [
      { title: "Restricted Products & Jurisdictions — BH Research Materials" },
      { name: "description", content: "BH policy on restricted products, quantities, and shipping jurisdictions." },
  ...
  component: () => (
    <PolicyPage eyebrow="Policy" title="Restricted Products & Jurisdictions">
      ...
      <p>Certain catalog items may be unavailable for sale in specific jurisdictions or through specific payment processors. BH may automatically disable purchasing for any catalog item and display: "Online purchasing is currently unavailable for this catalog item."</p>
      <h2>Restricted quantities</h2>
      <p>BH may limit order quantities per buyer, per organization, or per shipping destination.</p>
