...
export const Route = createFileRoute("/policies/refunds")({
  head: () => ({
    meta: [
      { title: "Refund & Cancellation Policy — BIOHACKERS" },
      { name: "description", content: "BIOHACKERS refund and order-cancellation policy for laboratory research materials." },
  ...
  component: () => (
    <PolicyPage eyebrow="Policy" title="Refund & Cancellation Policy">
      ...
      <p>BIOHACKERS may cancel any order that appears inconsistent with legitimate laboratory research, that fails compliance review, or that violates BIOHACKERS policies or applicable law.</p>
