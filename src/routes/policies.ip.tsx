...
export const Route = createFileRoute("/policies/ip")({
  ...
  component: () => (
    <PolicyPage eyebrow="Policy" title="Intellectual Property Policy">
      ...
      <p>Product names of investigational or approved compounds referenced on this website are used only to identify the material supplied and remain the property of their respective owners.</p>
